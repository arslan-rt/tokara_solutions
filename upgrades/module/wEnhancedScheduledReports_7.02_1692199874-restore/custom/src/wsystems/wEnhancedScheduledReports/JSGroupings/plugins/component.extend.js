...
; (function wEnhancedScheduledReports(app) {
    /**
    ...
    app.wsystems.wEnhancedScheduledReports = app.wsystems.wEnhancedScheduledReports || {};
    app.wsystems.wEnhancedScheduledReports.extendComponent = extendComponent;
})(SUGAR.App);
