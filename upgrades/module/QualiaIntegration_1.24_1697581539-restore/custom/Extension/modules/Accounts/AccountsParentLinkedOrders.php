<?php
namespace Sugarcrm\Sugarcrm\custom\Extension\modules\Accounts;

// class AccountsParentLinkedOrders extends Link2
// {/**
//  * DB
//  *
//  * @var DBManager
...
//         // $a  = $sugar_query->joinTable("accounts", ["joinType" => "INNER", "alias" => $jta]);

//         // $a->on()->equalsField($a->options["alias"] . ".id", $op->options["alias"] . ".parent_id");
//         // $a->on()->equals($a->options["alias"] . ".id", $this->focus->id);
//         // $a->on()->equals($op->options["alias"] . ".parent_type", "Accounts");
