({
    ...
    initModel: function () {
        ...
        var fetchEndpoint = function () {   
            var url = app.api.buildURL("wReportsDashlet", "settings/get");
            var callbacks = {
        ...
        var saveEndpoint = function () {
            self.alertLoading("settings-set-pending", "LBL_WREPORTSDASHLET_SAVE_SETTINGS_PROCESS");

            var url = app.api.buildURL("wReportsDashlet", "settings/set");
            var data = {
                "data": {}
            };
            ...
            if (_.isEmpty(data["data"][self.name]) === true) {                
                ...
                self.alertInfo("settings-set-info", "LBL_WREPORTSDASHLET_SAVE_SETTINGS_NO_DATA");
                self.exitPage();
            ...
            var callbacks = {
                "success": function saveDataSuccess() {
                    ...
                    self.alertDismissAll();
                    self.alertSuccess("settings-set-success", "LBL_WREPORTSDASHLET_SAVE_SETTINGS_SUCCESS");
                    self.exitPage();
                },
                "error": function saveDataError() {
                    ...
                    self.alertDismissAll();
                    self.alertError("settings-set-success", "LBL_WREPORTSDASHLET_SAVE_SETTINGS_ERROR");
                },
            };
            var options = {
                "skipMetadataHash": true
